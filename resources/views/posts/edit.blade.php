                    ...
                    @endif
                      ...
                      <form method="POST" action="{{ url('/editpost' ,array($posts->id)) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea rows="7" id="post_body" type="post_body" class="form-control @error('post_body') is-invalid @enderror" name="post_body" value="" required autocomplete="email">{{$posts->post_body}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="category_id" type="category_id" class="form-control @error('category_id') is-invalid @enderror" name="category_id" value="{{ $category->id }}" required autocomplete="email" >
